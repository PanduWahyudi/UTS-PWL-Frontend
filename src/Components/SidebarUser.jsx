            ...
            <ul className="flex-col gap-10">
              <li className="absolute flex items-center justify-center inset-x-0 mt-16 ">
                <a
                  ...
                  type="button"
                  className="w-[80%] border-2 border-white rounded-lg p-3 flex gap-4 text-start justify-start items-center text-sm font-medium text-white"
                >
                  <svg
                    width="29"
                    height="29"
              ...
              <li className="absolute flex items-center justify-center inset-x-0 mt-[135px] ">
                <a
                  ...
                  type="button"
                  className="w-[80%] border-2 border-white p-3 flex gap-4 text-start justify-start items-center text-sm font-medium rounded-lg  
                  text-white"
                >
                  <svg
                    width="29"
