    ...
    <div className="">
      ...
      >
        <div className="h-full px-4 py-4 overflow-y-auto bg-primary">
          <div className="flex items-center justify-center text-4xl font-bold text-[#FBDF07] p-2">
            Jaya Elektronik
          </div>
            ...
            <ul className="flex-col gap-10">
              <li className="absolute flex items-center justify-center inset-x-0 mt-16">
                <a
                  ...
                  type="button"
                  className="w-[80%] border-2 border-white p-3 flex gap-4 text-start justify-start items-center text-sm font-medium text-white rounded-lg"
                >
                  <svg
                    width="29"
                    height="29"
              ...
              <li className="absolute flex items-center justify-center inset-x-0 mt-[205px] ">
                <a
                  href="/user/user-page"
                  type="button"
                  className="w-[80%] border-2 border-white  p-3 flex gap-4 text-start justify-start items-center text-sm font-medium rounded-lg  text-white  "
                >
                  <svg
                    width="33"
                    height="32"
              ...
              <li className="absolute w-full -inset-x-1 bottom-0">
                <button
                  type="button"
                  id="logOut"
                  className="gap-3 w-52 py-1 mb-5 flex items-center justify-center m-auto rounded-md bg-[#FE0000] text-white p-2 pt-2 pb-2"
                >
                  Logout
                </button>
              </li>
      ...
      <div className=" pl-[280px] h-screen p-5 ">
        <div className="bg-slate-50 p-4 rounded shadow-lg h-full">
          {children}
        </div>
      </div>
    </div>
