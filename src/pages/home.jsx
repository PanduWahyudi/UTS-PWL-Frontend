...
const Home = () => {
  const [products] = useState([
    { id: 1, image: "Images/kulkas.jpg", name: "Kulkas", price: 3000000 },
    {
      id: 2,
      image: "Images/mesinCuci.jpg",
      name: "Mesin Cuci",
      price: 50000000,
    },
    { id: 3, image: "Images/televisi.jpg", name: "Televisi", price: 2000000 },
    { id: 4, image: "Images/Ac.jpg", name: "Air Conditioner", price: 30000000 },
    {
      id: 5,
    ...
    { id: 6, image: "Images/Blender.jpg", name: "Blender", price: 2500000 },
    { id: 7, image: "Images/microwave.jpg", name: "Microwave", price: 1500000 },
    { id: 8, image: "Images/Setrika.jpg", name: "Setrika", price: 150000 },
    {
      id: 9,
      image: "Images/kipasAngin.jpg",
      name: "Kipas Angin",
      price: 500000,
    },
    {
        ...
        <div className="left w-[70%] h-full ">
          <div className="head mb-[20px]">
            <div className="text-[33px] font-semibold">
              Teknologi Terkini, Harga Terbaik
            </div>
            <div className="text-[16px]">
              Temukan barang elektronik favoritmu di sini
            </div>
          </div>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="btn flex justify-end mt-2">
                  <button
                    className="btn text-[11px] text-white bg-primary rounded p-2 hover:bg-[#323896]"
        ...
        <div className="right w-[30%] px-3 flex items-center justify-center ">
          <div className="keranjang produk bg-white h-[95%] w-full rounded-lg p-2 py-3 flex flex-col justify-between shadow-lg">
            <div className="produk  h-[85%]">
              <div className="head ">
                <h2 className="text-[18px] font-bold mb-4">Keranjang Pesanan</h2>
                <div className="total-items-in-cart flex justify-between mb-4">
                  <p>Total Barang Dalam Keranjang:</p>
            ...
            <div className="bottom ">
              ...
              <button className="bg-[#FFC436] text-black font-bold w-full p-2 rounded-md">
                Checkout
              </button>
            </div>
          </div>
